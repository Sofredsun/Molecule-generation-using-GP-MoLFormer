...
3. **Выбор стартовой точки генерации** - из пяти ингибиторов был выбран энкорафениб по трем критериям:
...
2. **Генерация молекул** - генерация молекул осуществлялась путем авторегрессионного сэмплинга на основе фрагмента энкорафениба. Для каждой температуры из диапазона [0.3–1.1] сгенерировано по 500 молекул (seed=42). 
